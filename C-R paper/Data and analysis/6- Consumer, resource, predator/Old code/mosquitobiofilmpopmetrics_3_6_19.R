...
g5 <- ggplotGrob(Productivitymortality5)
g6 <- ggplotGrob(ProductivityR6)
g7 <- ggplotGrob(microbesfecundity1)
g8 <- ggplotGrob(microbesmortality2)
g9 <- ggplotGrob(microbesmortalityNR3)
...
png("C:/Users/Mitzi/Dropbox/Mosquito Science (1)/Data 2011 to 2018/Figures/allpopdynamicsdensity.png", width = 9 ,height = 7, units = 'in', res = 800)
grid.arrange(g123456789)
dev.off()
