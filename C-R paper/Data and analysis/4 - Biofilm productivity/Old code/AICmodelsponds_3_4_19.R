...
yandresids<-mutate(yandresids, resids = predictyscaled-BiofilmProdactual)
...
Depthadjustedy<-as.data.frame((0.01836058*(biofilmpondata$meanDepth-mean(biofilmpondata$meanDepth))-yandresids$resids)+mean(biofilmpondata$BiofilmProd))
