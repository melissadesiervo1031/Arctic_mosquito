...
CO2counts20172018<- read.csv("Adultmosquitoes/data/C02counts_weather2017_2018.csv") 

#### wind speeds were updated from 2018 to be in the same units as 2017###
## on 7/20/21 I added topographic roughness values from RAF,...###
...
C02sitechar<- read.csv("C:/Users/Melissa/Dropbox/Mosquito Science/Data 2011 to 2018/Github repository/Arctic_mosquito/Adultpaper/C02traps/C02sitechar.csv")
...
sweep2018<- read.csv("C:/Users/Melissa/Dropbox/Mosquito Science/Data 2011 to 2018/Github repository/Arctic_mosquito/Adultpaper/Sweepnet/2018/Sweep2018.csv")
...
sweep2018$Samplingevent<-as.factor(sweep2018$Samplingevent)
...
invertcounts2018<- read.csv("C:/Users/Melissa/Dropbox/Mosquito Science/Data 2011 to 2018/Github repository/Arctic_mosquito/C-R paper/Data and analysis/Inputs/invertcountsperimemerg2018.csv")
...
ggplot(sweep2018, aes(x = Lat, y = Long, size = resid)) +
  geom_point() +
...
####very mild evidence for autocorrellation....####

##Try with sampling event####

model2 <- glm.nb(round(Total)~Samplingevent*Site2, data = sweep2018)

acf(model2$residuals, type = "correlation")

###no real autocorrelation with the sampling event instead of date...###

###doesn't really make sense here to build an autocorrellated model since dates are not evenly spaced...??##



###trying some mixed effects models####
...
check_singularity(propgravid) ##TRUE...Hmmmm###
...
testSpatialAutocorrelation(sims, x = CO2counts2018cumsum$Lat, y = CO2counts2018cumsum$Long, plot = FALSE)
...
jpeg("C:/Users/Melissa/Dropbox/Mosquito Science (1)/Data 2011 to 2018/Github repository/Arctic_mosquito/Adultpaper/Figures/cumulativesum2018.jpeg",width = 6, height = 4,units = 'in', res = 600)
C02traps2018cumsum
dev.off()
...
jpeg("C:/Users/Melissa/Dropbox/Mosquito Science (1)/Data 2011 to 2018/Github repository/Arctic_mosquito/Adultpaper/Figures/cumulativesum2018LH.jpeg",width = 6, height = 4,units = 'in', res = 600)
C02traps2018cumsumLH
dev.off()

latlong<-cbind(X=CO2counts2018cumsum$Lat, Y=CO2counts2018cumsum$Long)
coordinates(latlong) <- ~ Y + X


minx<-min(CO2counts2018cumsum$Easting-100)
maxx<-max(CO2counts2018cumsum$Easting+100)
miny<-min(CO2counts2018cumsum$Northing-100)
maxy<-max(CO2counts2018cumsum$Northing+100)


x<-CO2counts2018cumsum$Easting
y<-CO2counts2018cumsum$Northing
m<-CO2counts2018cumsum$Countperhour

Q <- ppp(x, y, c(505000,535000),c(7430000,7445000), marks = m, markscale=0.005)
plot(Q)
...
jpeg("C:/Users/Melissa/Dropbox/Mosquito Science/Data 2011 to 2018/Github repository/Arctic_mosquito/Adultpaper/Figures/Weatherggplot.jpeg",width = 3, height = 6,units = 'in', res = 600)
Weatherplots
dev.off()
...
jpeg("C:/Users/Melissa/Dropbox/Mosquito Science/Data 2011 to 2018/Github repository/Arctic_mosquito/Adultpaper/Figures/loglarvaeemerCO2.jpeg",width = 6, height = 5,units = 'in', res = 600)
loglarvaeemerCO2_2
dev.off()
...
jpeg("C:/Users/Melissa/Dropbox/Mosquito Science/Data 2011 to 2018/Github repository/Arctic_mosquito/Adultpaper/Figures/larvaeemerg.jpeg",width = 3, height = 3,units = 'in', res = 600)
larvemergplot
dev.off()
...
jpeg("C:/Users/Melissa/Dropbox/Mosquito Science/Data 2011 to 2018/Github repository/Arctic_mosquito/Adultpaper/Figures/gravidplot.jpeg",width = 5, height = 3,units = 'in', res = 600)
gravidplot
dev.off()
